...
assert(helper:find('type(window.SetScale)=="function"',1,true),"helper scale capability guard missing")
assert(helper:find("window:SetScale(requestedScale)",1,true),"helper scale inheritance missing")
